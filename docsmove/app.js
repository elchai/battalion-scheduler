// ==================== DocsMove - Digital Signature App ====================
// Standalone signature system for battalion-scheduler

// ==================== STATE ====================
const DM = {
    view: 'dashboard', // dashboard, templates, create, sign
    docs: JSON.parse(localStorage.getItem('docsmove_docs') || '[]'),
    templates: JSON.parse(localStorage.getItem('docsmove_templates') || '[]'),
    // Editor state
    step: 1,
    docImage: null,
...
function save() {
    localStorage.setItem('docsmove_docs', JSON.stringify(DM.docs));
    localStorage.setItem('docsmove_templates', JSON.stringify(DM.templates));
}
