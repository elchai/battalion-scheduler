...
const FULL_ACCESS_IDS = ['5242848', '5075570', '5212536', '8055119', '6368785'];
...
function renderSoldierShifts() {
    ...
    container.innerHTML = compShifts.slice(-15).reverse().map(sh => {
        ...
        return `<div style="background:var(--card);border-radius:var(--radius);padding:12px 16px;margin-bottom:8px;border-right:4px solid ${borderColor};">
            ...
            <div style="font-size:0.82em;color:var(--text-light);">${sh.date ? formatDate(sh.date) : ''} ${sh.time || ''}</div>
...
function seedCompanyBLeavesIfNeeded() {
    const SEED_KEY = CONFIG.storagePrefix + 'CompanyBLeaves_v1';
    if (localStorage.getItem(SEED_KEY)) return;
    // [pid, startDate, endDate, notes]  — dates YYYY-MM-DD, from March–May 2026 roster
    const L = [
        ['4304963','2026-03-22','2026-03-24','חופש אושר'],
        ['5001901','2026-04-01','2026-04-02','חופש אושר'],
        ['5065640','2026-03-22','2026-03-22','חופש חלקי'],
        ['5065640','2026-03-25','2026-03-25','חופש חלקי'],
        ['5065640','2026-04-12','2026-04-21','חופש חלקי'],
        ['5122197','2026-04-01','2026-04-02','חופש חלקי'],
        ['5122197','2026-04-21','2026-04-21','חופש חלקי'],
        ['5203829','2026-04-21','2026-05-01','חופש אושר'],
        ['5231792','2026-04-01','2026-04-02','חופש אושר'],
        ['5248815','2026-04-01','2026-04-02','חופש אושר'],
        ['5270010','2026-04-23','2026-04-29','חופש אושר'],
        ['5342196','2026-04-01','2026-04-02','חופש אושר'],
        ['5384257','2026-03-25','2026-03-26','חופש חלקי'],
        ['5384257','2026-03-29','2026-04-02','חופש חלקי'],
        ['5384257','2026-04-05','2026-04-09','חופש חלקי'],
        ['5384257','2026-04-12','2026-04-15','חופש חלקי'],
        ['5384257','2026-04-19','2026-04-20','חופש חלקי'],
        ['5384257','2026-04-23','2026-04-23','חופש חלקי'],
        ['5384257','2026-04-26','2026-04-30','חופש חלקי'],
        ['5485066','2026-04-05','2026-04-18','חופש אושר'],
        ['5485066','2026-05-03','2026-05-05','חופש אושר'],
        ['5498759','2026-03-29','2026-03-31','חופש חלקי'],
        ['5498759','2026-04-05','2026-04-09','חופש חלקי'],
        ['5498759','2026-04-12','2026-04-12','חופש חלקי'],
        ['5498759','2026-04-15','2026-04-15','חופש חלקי'],
        ['5498759','2026-04-19','2026-04-21','חופש חלקי'],
        ['5498759','2026-04-26','2026-04-28','חופש חלקי'],
        ['5749191','2026-04-24','2026-04-24','חופש אושר'],
        ['5777584','2026-04-01','2026-04-02','חופש אושר'],
        ['5777584','2026-04-22','2026-04-22','חופש אושר'],
        ['5943507','2026-04-16','2026-04-30','חופש אושר'],
        ['6055145','2026-04-28','2026-04-30','חופש אושר'],
        ['6920798','2026-04-01','2026-04-02','חופש חלקי'],
        ['6920798','2026-04-19','2026-04-20','חופש חלקי'],
        ['6920798','2026-04-30','2026-04-30','חופש חלקי'],
        ['7306641','2026-04-05','2026-04-05','חופש חלקי'],
        ['7306641','2026-04-11','2026-04-11','חופש חלקי'],
        ['7485966','2026-03-24','2026-03-24','חופש חלקי'],
        ['7485966','2026-03-29','2026-04-01','חופש חלקי'],
        ['7485966','2026-04-04','2026-04-04','חופש חלקי'],
        ['8151825','2026-04-09','2026-04-15','חופש חלקי'],
        ['8472206','2026-04-12','2026-04-12','חופש אושר'],
        ['8496642','2026-03-24','2026-03-24','חופש חלקי'],
        ['8496642','2026-03-29','2026-04-01','חופש חלקי'],
        ['8496642','2026-04-10','2026-04-14','חופש חלקי'],
        ['8496642','2026-04-17','2026-04-21','חופש חלקי'],
        ['8496642','2026-04-24','2026-04-28','חופש חלקי'],
        ['8572758','2026-04-01','2026-04-02','חופש אושר'],
        ['8652030','2026-03-26','2026-03-26','חופש חלקי'],
        ['8652030','2026-03-31','2026-03-31','חופש חלקי'],
        ['8652030','2026-04-07','2026-04-09','חופש חלקי'],
        ['8652030','2026-04-12','2026-04-15','חופש חלקי'],
        ['8652030','2026-04-21','2026-04-23','חופש חלקי'],
        ['8652030','2026-04-28','2026-04-30','חופש חלקי'],
        ['8665393','2026-03-22','2026-03-26','חופש אושר'],
        ['9049896','2026-03-22','2026-03-22','חופש חלקי'],
    ];
    let added = 0;
    L.forEach(([pid, startDate, endDate, notes]) => {
        const sol = state.soldiers.find(s => (s.personalId === pid || s.id === 'b_' + pid) && s.company === 'b');
        if (!sol) return;
        const dup = state.leaves.find(l => l.soldierId === sol.id && l.startDate === startDate && l.endDate === endDate);
        if (dup) return;
        state.leaves.push({
    ...
    if (added > 0) { saveState(); console.log('Seeded', added, 'company B leaves'); }
...
function renderCompanyTab(compKey) {
    ...
    container.innerHTML = `
        <div class="action-bar">
            ...
            <button class="btn btn-special" onclick="_autoScheduleTaskFilter=null;openAutoSchedule('${compKey}')">שיבוץ אוטומטי</button>` : ''}
        ...
        <div class="sub-section">
                    ...
                    <tbody>
                        ${comp.tasks.map(t => {
                            ...
                            return `<tr style="${editShifts ? 'cursor:pointer;' : ''}" ${editShifts ? `onclick="openAddShift('${compKey}','${esc(t.name)}')" title="לחץ לשיבוץ"` : ''}>
                                ...
                                ${editShifts ? `<td style="text-align:center;"><button class="btn btn-special btn-sm" onclick="event.stopPropagation();openAutoScheduleForTask('${compKey}','${esc(t.name)}')" title="שיבוץ אוטומטי למשימה זו" style="font-size:0.75em;padding:3px 8px;">⚡</button></td>` : ''}
                            </tr>`;
                        }).join('')}
                        ${(() => {
            ...
            ${(getUserPermissionLevel() >= PERM.COMPANY_CMD) ? `<div style="text-align:center;padding:10px 0;"><button class="btn btn-add" onclick="switchTab('settings');setTimeout(()=>{ document.querySelector('.settings-task-anchor')?.scrollIntoView({behavior:'smooth'}); },200)">⚙ הגדרת משימות פלוגתי</button></div>` : ''}
        </div>
...
function openAddSoldier(company) {
    ...
    document.getElementById('soldierTaskRestriction').value = '';
...
function openSoldierProfile(id) {
    ...
    html += `<div class="sp-section sp-info">
        <div class="sp-info-grid">
            ...
            ${sol.taskRestriction ? `<div class="sp-info-item"><span class="sp-label">הגבלת משימות</span><span class="sp-value" style="color:var(--danger);font-weight:600;">${getTaskRestrictionLabel(sol.taskRestriction)}</span></div>` : ''}
    ...
    if (soldierExercises.length > 0) {
        ...
        soldierExercises.slice(0, 10).forEach(ex => {
            ...
            html += `<div class="sp-list-item"><span>${evt ? esc(evt.eventName) : '—'}</span><span>${ex.trainingDate ? formatDate(ex.trainingDate) : ''}</span><span style="font-weight:600;">${ex.commanderRating}</span></div>`;
        });
        html += `</div></details>`;
    }
    ...
    if (soldierShootingResults.length > 0) {
        ...
        soldierShootingResults.slice(0, 10).forEach(r => {
            ...
            html += `<div class="sp-list-item"><span>${drill ? esc(drill.drillName) : '—'}</span><span>${r.executionDate ? formatDate(r.executionDate) : ''}</span><span style="font-weight:700;color:${r.scorePercentage >= 80 ? '#2e7d32' : r.scorePercentage >= 60 ? '#ff9800' : '#c62828'};">${r.scorePercentage}%</span></div>`;
        });
        html += `</div></details>`;
    }
...
function openEditSoldier(id) {
    ...
    document.getElementById('soldierTaskRestriction').value = sol.taskRestriction || '';
...
function saveSoldier() {
    ...
    if (editId) {
        ...
        if (sol) {
            ...
            sol.taskRestriction = document.getElementById('soldierTaskRestriction').value;
        ...
        const soldier = {
            ...
            taskRestriction: document.getElementById('soldierTaskRestriction').value,
...
function renderShiftRoleSlots(restoreSoldiers) {
    ...
    const soldiers = state.soldiers.filter(s => s.company === company)
        .sort((a, b) => {
            const aStatus = getSoldierShiftStatus(a.id, date, startTime, endTime, taskName);
            const bStatus = getSoldierShiftStatus(b.id, date, startTime, endTime, taskName);
    ...
    function slotHtml(role, idx, label, preselect) {
        const options = soldiers.map(s => {
            const status = getSoldierShiftStatus(s.id, date, startTime, endTime, taskName);
            let info = '';
            if (status.notArrived) info = ' ❌ לא גויס';
            else if (status.restricted) info = ` ⛔ ${status.assignedTo}`;
...
function getSoldierShiftStatus(soldierId, date, startTime, endTime, taskName) {
    ...
    // Check task restriction
    if (soldier && taskName) {
        const restrictionMsg = checkTaskRestriction(soldier, taskName, startTime, endTime);
        if (restrictionMsg) {
            return { available: false, onLeave: false, assignedTo: restrictionMsg, restricted: true };
        }
    }
...
let _autoScheduleTaskFilter = null; // When set, only schedule this specific task

function openAutoScheduleForTask(compKey, taskName) {
    _autoScheduleTaskFilter = taskName;
    openAutoSchedule(compKey);
    // Update title to show task name
    document.getElementById('autoScheduleTitle').textContent = `שיבוץ אוטומטי — ${compName(compKey)} — ${taskName}`;
}

function openAutoSchedule(compKey) {
    _autoScheduleCompany = compKey;
    if (!_autoScheduleTaskFilter) _autoScheduleTaskFilter = null; // reset when opened normally
...
function generateScheduleProposal(compKey, startDate, endDate) {
    ...
    function pickSoldier(date, startTime, endTime, roleFilter, taskName) {
        const eligible = soldiers.filter(s => {
            ...
            // Check task restriction
            const restrictionMsg = checkTaskRestriction(s, taskName, startTime, endTime);
            if (restrictionMsg) return false;
    ...
    dates.forEach(date => {
        ...
        const tasksToSchedule = _autoScheduleTaskFilter
            ? comp.tasks.filter(t => t.name === _autoScheduleTaskFilter)
            : comp.tasks;
                ...
                <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:8px;">
                    <div>
                        ...
                        <div style="font-size:0.82em;color:var(--text-light);margin-top:4px;">
                            ...
                            ${evt.trainingDate ? ' • ' + formatDate(evt.trainingDate) : ''}
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:8px;">
                <div>
                    ...
                    <div style="font-size:0.82em;color:var(--text-light);margin-top:2px;">
                        ${exec.executionDate ? formatDate(exec.executionDate) : ''} • ${compName(exec.company)}
...
// ==================== TASK RESTRICTION HELPERS ====================
const TASK_RESTRICTION_LABELS = {
    hafak_only: 'חפ"ק בלבד',
    static_only: 'עמדות סטטיות בלבד',
    no_night: 'ללא משמרות לילה',
    light_duty: 'תפקוד קל בלבד'
};

function getTaskRestrictionLabel(restriction) {
    return TASK_RESTRICTION_LABELS[restriction] || restriction || '';
}

// Check if a soldier's task restriction allows assignment to a given task/shift
// Returns null if allowed, or a message string if blocked
function checkTaskRestriction(soldier, taskName, startTime, endTime) {
    if (!soldier || !soldier.taskRestriction) return null;
    const r = soldier.taskRestriction;
    const tn = (taskName || '').toLowerCase();

    if (r === 'hafak_only') {
        // Only allow tasks containing חפ"ק or חפק
        if (!tn.includes('חפ') && !tn.includes('מטה') && !tn.includes('אג"מ') && !tn.includes('אגמ')) {
            return 'מוגבל לחפ"ק בלבד';
        }
    } else if (r === 'static_only') {
        // Only static positions — block patrols, initiatives, mobile tasks
        const mobileTasks = ['סיור', 'יזומ', 'כוננות', 'ניידת', 'פטרול', 'אבטח'];
        if (mobileTasks.some(mt => tn.includes(mt))) {
            return 'מוגבל לעמדות סטטיות בלבד';
        }
    } else if (r === 'no_night') {
        // Block night shifts (22:00-06:00)
        const st = startTime || '00:00';
        if (st >= '22:00' || st < '06:00') {
            return 'ללא משמרות לילה';
        }
    } else if (r === 'light_duty') {
        // Block combat/heavy tasks
        const heavyTasks = ['סיור', 'יזומ', 'כוננות', 'ניידת', 'פטרול', 'אבטח', 'שמירה חמושה'];
        if (heavyTasks.some(ht => tn.includes(ht))) {
            return 'תפקוד קל בלבד';
        }
    }
    return null;
}
...
function generateSignaturePDF(logEntry, eqUnused, sol) {
    ...
    const soldierRank = sol.rank || '-';
    const issuerRank = logEntry.issuerRank || '-';
    ...
    <div style="direction:rtl;font-family:'David','Segoe UI',Arial,sans-serif;max-width:700px;margin:auto;padding:20px 28px;color:#1a1a1a;">
        ...
        <!-- Soldier details (matching 1003 fields) -->
        <table style="width:100%;border-collapse:collapse;margin-bottom:14px;font-size:0.9em;">
            ...
            <tr>
                <td style="padding:6px 10px;font-weight:700;font-size:0.82em;color:#555;border-bottom:1px solid #e0e0e0;">${pdfTxt('דרגה')}</td>
                <td style="padding:6px 10px;font-size:0.95em;border-bottom:1px solid #e0e0e0;">${pdfTxt(soldierRank)}</td>
            ...
            <tr>
                ...
                <td style="padding:6px 10px;font-weight:700;font-size:0.82em;color:#555;border-bottom:1px solid #e0e0e0;">${pdfTxt('תפקיד')}</td>
                <td style="padding:6px 10px;font-size:0.95em;border-bottom:1px solid #e0e0e0;">${pdfTxt(sol.role || '-')}</td>
            </tr>
        ...
        <table style="width:100%;border-collapse:collapse;margin-bottom:14px;font-size:0.88em;border:1px solid #333;">
            <thead>
                <tr style="background:#1a3a5c;color:white;">
                    ...
                    <th style="padding:6px 10px;border:1px solid #1a3a5c;text-align:center;">${pdfTxt('הערות')}</th>
                </tr>
            </thead>
            <tbody>${items.map((item, i) => `
                <tr style="${i % 2 ? 'background:#f9f9f9;' : ''}">
                    ...
                    <td style="padding:5px 10px;text-align:center;border:1px solid #d0d7de;">${pdfTxt(item.equipNotes || '')}</td>
                </tr>
            `).join('')}</tbody>
        </table>
        ...
        <!-- Two signature sections (1003 format) -->
        <table style="width:100%;border-collapse:collapse;margin-bottom:10px;font-size:0.82em;">
            <tr>
                <!-- היחידה המקבלת (receiving unit / soldier) -->
                <td style="width:50%;vertical-align:top;padding:0 6px 0 10px;">
                    <div style="font-weight:700;font-size:0.95em;margin-bottom:6px;text-align:center;background:#f0f4f8;padding:4px;border:1px solid #d0d7de;">${pdfTxt('היחידה המקבלת')}</div>
                    <table style="width:100%;border-collapse:collapse;">
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;width:50px;">${pdfTxt('שם')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${pdfTxt(sol.name)}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('דרגה')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${pdfTxt(soldierRank)}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('מ.א')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${sol.personalId || '-'}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('תאריך')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${dateStr}</td></tr>
                    </table>
                    <div style="text-align:center;margin-top:6px;">
                        <div style="font-weight:600;font-size:0.9em;margin-bottom:4px;">${pdfTxt('חתימה')}</div>
                        <img src="${logEntry.signatureImg}" style="max-width:220px;height:60px;border:1px solid #ccc;background:#fff;">
                    </div>
                </td>
                <!-- היחידה המנפיקה (issuing unit) -->
                <td style="width:50%;vertical-align:top;padding:0 10px 0 6px;border-right:1px solid #d0d7de;">
                    <div style="font-weight:700;font-size:0.95em;margin-bottom:6px;text-align:center;background:#f0f4f8;padding:4px;border:1px solid #d0d7de;">${pdfTxt('היחידה המנפיקה')}</div>
                    <table style="width:100%;border-collapse:collapse;">
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;width:50px;">${pdfTxt('שם')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${pdfTxt(logEntry.issuedBy || '-')}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('דרגה')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${pdfTxt(issuerRank)}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('מ.א')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${logEntry.issuerPersonalId || '-'}</td></tr>
                        <tr><td style="padding:3px 6px;font-weight:600;color:#555;">${pdfTxt('תאריך')}</td><td style="padding:3px 6px;border-bottom:1px solid #e0e0e0;">${dateStr}</td></tr>
                    </table>
                    <div style="text-align:center;margin-top:6px;">
                        <div style="font-weight:600;font-size:0.9em;margin-bottom:4px;">${pdfTxt('חותמת יחידה')}</div>
                        ${DOC_STAMP_BASE64 ? `<img src="${DOC_STAMP_BASE64}" style="max-height:60px;opacity:0.9;">` : `<div style="height:60px;border:1px dashed #ccc;display:flex;align-items:center;justify-content:center;color:#bbb;font-size:0.8em;">${pdfTxt('חותמת')}</div>`}
                    </div>
                </td>
            </tr>
        </table>
...
function renderTasksPage() {
    ...
    companies.forEach(k => {
        ...
        tasks.forEach(t => {
            ...
            const assignedShifts = state.shifts.filter(sh => sh.company === k && sh.task === t.name && shiftCoversDate(sh, todayStr));
    ...
    filteredData.forEach(comp => {
        const cardsHtml = comp.tasks.map(t => {
            ...
            const shiftsHtml = slotNeeded > 0 ? shiftTimes.map(s => {
                const cnt = state.shifts.filter(sh => sh.company === comp.key && sh.task === t.name && sh.startTime === s.start && shiftCoversDate(sh, todayStr)).reduce((acc, sh) => acc + (sh.soldiers?.length || 0), 0);
